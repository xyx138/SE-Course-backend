...
> 这会同时启动API服务和Gradio前端界面。API服务运行在8000端口，Gradio界面运行在7860端口。

7. 访问[用户界面](http://localhost:7860/)， 效果如下

- 工具调用

  ![image-20250511131333377](https://raw.githubusercontent.com/xyx138/cloudimg/master/img/image-20250511131333377.png)

- 知识库管理

  ![image-20250511131550252](https://raw.githubusercontent.com/xyx138/cloudimg/master/img/image-20250511131550252.png)

- 知识库挂载

  ![image-20250511131744651](https://raw.githubusercontent.com/xyx138/cloudimg/master/img/image-20250511131744651.png)
...
系统采用双线程架构设计：
- **主线程**：运行FastAPI服务，处理HTTP请求
- **Agent线程**：初始化和运行Agent，处理所有工具调用
- 这种架构确保了事件循环隔离，解决了跨线程边界问题，使工具调用更加稳定可靠
